  ...
  Plugin = function () {
    ...
    _createClass(Plugin, [{
      ...
      value: function depends_on() {
        return this.$element.data('depends-on');
      }
    }, {
      key: 'depends_on_any',
      value: function depends_on_any() {
        return this.depends_on()['depends_on_any'];
      }
    }, {
      key: 'depends_on_all',
      value: function depends_on_all() {
        return this.depends_on()['depends_on_all'];
      }
    }, {
      key: 'depends_on_none',
      ...
      key: 'get_input',
      value: function get_input(name) {
        return this.get_inputs().filter('[name$=\'[' + name + ']\']');
      }
    }, {
      key: 'get_input_names',
      value: function get_input_names() {
        return Object.keys(this.depends_on_any() || {}).concat(Object.keys(this.depends_on_all() || {}).concat(Object.keys(this.depends_on_none() || {})));
      }
    }, {
      key: 'get_inputs',
      ...
      value: function is_dependent_on_input($input) {
        return (0, _lodash.filter)(this.get_input_names(), function (name) {
      ...
      key: 'show_content',
      value: function show_content() {
        var html;
        if (this.$element.children().length > 0) {
          return;
        }
        if (!(html = this.$element.data('template-html'))) {
          return;
        }
      ...
      key: 'hide_content',
      value: function hide_content() {
        var template_html;
        template_html = this.$element.children().remove();
        if (!this.$element.data('template-html')) {
      ...
      value: function is_condition_valid() {
        switch (false) {
          case !this.depends_on_any():
            return this.is_any_valid();
          case !this.depends_on_all():
            return this.is_all_valid();
          case !this.depends_on_none():
            return this.is_none_valid();
        }
      }
    }, {
      key: 'is_any_valid',
      value: function is_any_valid() {
        var input_value, j, len, name, ref, ref1, res, value, values;
        res = false;
        ref = this.depends_on_any();
        for (name in ref) {
          values = ref[name];
          ref1 = (0, _lodash.flatten)([values]);
          for (j = 0, len = ref1.length; j < len; j++) {
            value = ref1[j];
            input_value = this.is_valid(name, value);
            res = res || input_value;
          }
        }
        return res;
      ...
      key: 'is_all_valid',
      value: function is_all_valid() {
        var input_value, j, len, name, ref, ref1, res, value, values;
        res = true;
        ref = this.depends_on_all();
        for (name in ref) {
          values = ref[name];
          ref1 = (0, _lodash.flatten)([values]);
          for (j = 0, len = ref1.length; j < len; j++) {
      ...
      key: 'is_none_valid',
      value: function is_none_valid() {
        var input_value, j, len, name, ref, ref1, res, value, values;
        res = true;
        ref = this.depends_on_none();
        for (name in ref) {
          values = ref[name];
          ref1 = (0, _lodash.flatten)([values]);
          for (j = 0, len = ref1.length; j < len; j++) {
      ...
      key: 'is_valid',
      value: function is_valid(name, value) {
        var $input;
        ...
        switch ($input.prop('type')) {
          case 'radio':
            return $input.filter(':checked').val() === value;
          case 'checkbox':
            switch (value) {
              case '1':
                return $input.filter(':checked').length > 0;
              default:
                return $input.not(':checked').length > 0;
            }
            break;
          case 'select-one':
            return $input.val() === value;
          case 'select-multiple':
            return indexOf.call($input.val(), value) >= 0;
          default:
            return $input.val() === value;
        }
      }
